...
usher_to_taxonium -i mpx.pb -g NC_063383.gb -o mpx.jsonl.gz -m metadata.csv --columns date,country,region,clade,host,sraAccession --only_variable_sites --key_column=accession
rm masked.fa out.fa masked.tsv
