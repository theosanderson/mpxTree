#! /bin/bash
cat raxml/out.fa.raxml.bestTreeCollapsed | ./gotree reroot midpoint > rooted.nwk
...
usher_to_taxonium -i mpx.pb -g reference.gb -o mpx.jsonl.gz -m metadata.csv --columns date,country,region,clade,host,sraAccession --only_variable_sites
